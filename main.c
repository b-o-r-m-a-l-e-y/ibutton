...
//uint8_t EEMEM someDATA[] = {0x02,0x00,0x01,0xFF,0x00,0x00,0x00,0x01,0x62,0x25,0xD0,0x0C,0x00,0x00,0x00,0x01,0xCE,0x75,0xC3,0x00,0x00,0x00};
uint8_t EEMEM DATA[] = {0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF};

// Некоторые универсальные ключи
const unsigned char VEZDEHOD_KEY1[] PROGMEM = {0x01, 0x62, 0x25, 0xD0, 0x0C, 0x00, 0x00, 0x00}; //заменены
const unsigned char VEZDEHOD_KEY2[] PROGMEM = {0x01, 0xCE, 0x75, 0xC3, 0x00, 0x00, 0x00, 0xBF};
